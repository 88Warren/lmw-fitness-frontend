...
const NewsletterConfirmed = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center py-20 px-4 sm:px-6 md:px-8 bg-gradient-to-b from-white via-customGray/20 to-customGray/70">
      <motion.div
      ...
      >
        ...
        <p className="text-md md:text-lg text-logoGray font-titillium mb-4 md:mb-6">
