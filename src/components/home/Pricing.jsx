    ...
    <>
      ...
      <section id="Pricing" className="py-16 px-6 bg-gray-100">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-higherJump text-black mb-8">
            Choose Your P<span className="l">l</span>
            an
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-white border rounded-lg shadow-lg">
              ...
              <p className="text-lg font-semibold text-limeGreen mb-4">
                £50 (One-off fee)
              </p>
            ...
            <div className="flex flex-col md:flex-row justify-center gap-10">
              ...
              <div className="bg-white md:w-1/2 p-6 rounded-lg text-customGray shadow-md">
                ...
                <div className="flex justify-center">
                  <Link to="/blog" className="btn-primary mb-2">
                    Subscribe Now
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white md:w-1/2 p-6 rounded-lg text-customGray shadow-md">
                ...
                <ul className="text-lg space-y-2 mb-4">
                  ...
                  <li>
                    ✔ <span className="font-bold">£20 off</span> any package
                    purchased within 30 days
                  </li>
                </ul>
                <div className="flex justify-center">
                  <Link to="/purchase-bonus-package" className="btn-primary">
                    Buy Now
                  </Link>
                </div>
              </div>
