    ...
    <>
      ...
      <section id="Testimonials" className="py-16 px-6 bg-customGray">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-higherJump text-customWhite word-spacing-wide mb-12 md:mb-20"><span className="w">W</span>hat <span className="text-brightYellow">M</span>y c<span className="l">l</span>ients say...</h2>
