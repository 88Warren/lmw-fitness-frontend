        ...
        <footer className="bg-customGray mx-auto max-w-7xl p-6 lg:py-8 text-white">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li><a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="hover:text-brightYellow">Github</a></li>
                        <li><a href="https://discord.gg/" target="_blank" rel="noopener noreferrer" className="hover:text-brightYellow">Discord</a></li>
                    </ul>
                </div>
