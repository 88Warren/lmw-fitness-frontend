    ...
    <div className="bg-white p-6 md:p-8 rounded-lg shadow-xl border-t-4 border-[#ffcf00] animate-fadeIn">
      ...
      <form onSubmit={handleFormSubmit} className="space-y-4">
        ...
        <div className="flex justify-end space-x-4 mt-6">
          <button
            type="button"
            onClick={handleBackToList} // Updated from handleCancelCreate
    ...
    <div className="min-h-screen bg-[#747474] pt-20 pb-10 font-titillium">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {viewMode === 'detail' && selectedPost ? (
          ...
          renderForm(false) // Render form for creating
        ) : viewMode === 'edit' && editingPost ? (
          renderForm(true) // Render form for editing
        ) : (
          // Blog Post List View
          <>
              ...
              {actualBlogPosts.map((post) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    {/* Optional: Add edit/delete buttons to list view directly */}
